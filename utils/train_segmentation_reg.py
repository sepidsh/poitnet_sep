...
from pointnet.dataset_iccv import ShapeNetDataset
from pointnet.model_reg import PointNetDenseCls, feature_transform_regularizer
...
for epoch in range(opt.nepoch):
    ...
    #print("cccc",classifier.state_dict())
    torch.save(classifier.state_dict(), '%s/seg_model_reg_es_%d.pth' % (opt.outf, epoch))
